          ...
          <div className="bg-gray-100 min-h-screen py-[7rem]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {status ? (
                <div>
                  <form className="mb-8">
                    <div className="flex flex-col sm:flex-row shadow-sm rounded-lg overflow-hidden">
                      ...
                      <button
                        type="submit"
                        className="bg-blue-500 text-white px-6 py-3 font-medium hover:bg-blue-500 transition duration-300 mt-2 sm:mt-0"
                      >
                        Áp dụng
                      </button>
                    </div>
                ...
                <div>
                  <p className="text-center text-blue-500 pb-5">
